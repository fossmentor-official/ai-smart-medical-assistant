                ...
                <div className="flex flex-col items-center justify-center min-h-[460px] gap-8 p-10">
                  <div className="text-center">
                    <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-1.5 mb-5">
                      ...
                      <span className="text-[12px] text-cyan-300 font-medium">Live Recording · No demo data</span>
                    </div>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-base shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:scale-[1.02] transition-all duration-200"
                  >
                    <Mic size={20} />
